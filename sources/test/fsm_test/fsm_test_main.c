...
int		main(int argc, char **argv)
{
	...
	fsm[0] = fsm_create_state((t_fsm_state){"init", f_init, "yey fsm init!", NULL, 2},
			(t_fsm_translation) {&fsm[1], f_translate_press_n},
			(t_fsm_translation) {&fsm[2], f_translate_press_a});

	fsm[1] = fsm_create_state((t_fsm_state){"print N", f_print_n, NULL, NULL, 2},
			(t_fsm_translation) {&fsm[0], f_translate_press_r},
			(t_fsm_translation) {&fsm[3], f_translate_press_e});

	fsm[2] = fsm_create_state((t_fsm_state) {"print A", f_print_a, NULL, NULL, 2},
			(t_fsm_translation) {&fsm[1], f_translate_press_n},
			(t_fsm_translation) {&fsm[3], f_translate_press_e});

	fsm[3] = fsm_create_state((t_fsm_state){"exit", f_exit, NULL, NULL, 0});
