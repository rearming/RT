...
static inline void		rt_init_pathtrace_params(t_pathtrace_params *out_pathtrace_params, t_cl_info clInfo)
{
	out_pathtrace_params->current_samples_num = 0;
	out_pathtrace_params->max_depth = clInfo.max_depth_pathtrace;
}

static inline void		rt_init_raytrace_params(t_raytrace_params *out_raytrace_params, t_cl_info clInfo)
{
